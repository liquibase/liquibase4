...
public class ClassLoaderResourceAccessor extends FileSystemResourceAccessor {
    ...
    protected List<Path> findRootPaths(ClassLoader classLoader) throws Exception {
        ...
        if (classLoader instanceof URLClassLoader) {
            ...
            logger.info("Found non-URLClassLoader classloader " + classLoader.toString() + ". Liquibase will try to figure out now to load resources from it, some may be missed. Consider using a custom ClassLoaderResourceAccessor subclass.");
