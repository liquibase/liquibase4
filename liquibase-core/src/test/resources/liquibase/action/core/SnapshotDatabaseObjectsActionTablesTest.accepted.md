...
| 1ebf62      | Unsupported Database | LBCAT.LBSCHEMA.CRAZY!@#\$%^&*()_+{}[]TABLE (TABLE)   | **plan**: getTables(LBCAT, LBSCHEMA, CRAZY!@#\$%^&*()_+{}[]TABLE, [TABLE])
...
| 86fafc      | Unsupported Database | LBCAT.LBSCHEMA.crazy!@#\$%^&*()_+{}[]table (TABLE)   | **plan**: getTables(LBCAT, LBSCHEMA, crazy!@#\$%^&*()_+{}[]table, [TABLE])
