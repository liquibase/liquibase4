...
public class AddAutoIncrementLogic extends AbstractSqlBuilderLogic<AddAutoIncrementAction> {
    ...
    protected StringClauses generateSql(AddAutoIncrementAction action, Scope scope) {
        ...
        clauses.append(Clauses.autoIncrement, generateAutoIncrementClause(action.autoIncrementDetails));
    ...
    public StringClauses generateAutoIncrementClause(Column.AutoIncrementDetails autoIncrementDetails) {
        ...
        StringClauses autoIncrementClauses = null;
        if (autoIncrementDetails != null) {
            autoIncrementClauses = new StringClauses("(", " ", ")");
            if (autoIncrementDetails.startWith != null) {
                autoIncrementClauses.append(Clauses.startWith, "START WITH "+autoIncrementDetails.startWith);
            }
            if (autoIncrementDetails.incrementBy != null) {
                autoIncrementClauses.append(Clauses.incrementBy, "INCREMENT BY "+autoIncrementDetails.incrementBy);
            }
        }
        clauses.append(Clauses.autoIncrementParameters, autoIncrementClauses);
